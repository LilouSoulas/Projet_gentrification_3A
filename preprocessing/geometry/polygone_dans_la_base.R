...
data_clean <- read.csv("base_lilou.csv")
...
data_clean$poly_5 <- st_sfc(data_clean$poly_5, crs = st_crs(data_clean))
#--------------------------------------------------------------------------
...
data_clean$poly_3 <- st_sfc(data_clean$poly_3, crs = st_crs(data_clean))
#--------------------------------------------------------------------------